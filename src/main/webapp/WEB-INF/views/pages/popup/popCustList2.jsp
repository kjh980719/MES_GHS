...
<script>
	...
	function choiceCust(name, no, cust_seq){
		console.log(parent.document.getElementById("asplanInfo_Form"));
		if(parent.document.getElementById("asplanInfo_Form") != null){
			parent.document.asplanInfo_Form.cust_seq.value = cust_seq;
			parent.document.asplanInfo_Form.cust_name.value = name;
		}else {
