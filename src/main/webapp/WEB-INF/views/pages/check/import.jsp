...
$(document).ready(function() {
	...
	setCalendarDefault();
    var colModel = [
        {label: "No", name:"rowIndex", align: "center", width: "20", sortable: false,resizable:true},
        {label: "발주코드", name:"ORDER_CODE", align: "center", width: "20", sortable: false,resizable:true},
        {label: "검사여부", name:"CHECK_YN", align: "center", width: "20", sortable: false,resizable:true},
        {label: "입고일자", name:"M_IN_DATE", align: "center", width: "20", sortable: false,resizable:true},
        {label: "검사일자", name:"CHECK_DATE", align: "center", width: "20", sortable: false,resizable:true}
    ...
    creatJqGrid("jqGrid_1", "/check/getInMaterialList", colModel, postData, "paginate_1", "dataCnt_1", "rowPerPage_1", "gridParent_1");
        ...
        <!--  관리자  검색시작-->
                  ...
                  <caption></caption>
                        ...
                        <th scope="row">검사여부</th>
                            <td colspan="4" class="left_pt10">
                                <select name="CHECK_YN" class="sel_box selectSearch">
                                	<option value=''>전체</option>                                  
                                    <option value='UII'>미검사</option>
                                    <option value='CII'>검사완료</option>
                                    <option value='NII'>무검사품</option>
                                </select>
                            </td>
                        </tr>
                    </table>
