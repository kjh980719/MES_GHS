...
<script>
	...
	function choiceManager(manager_seq, auth_group_name, manager_name, manager_position){
	 	...
	 	parent.document.softwareInfo_Form.manager_seq.value = manager_seq;
		parent.document.softwareInfo_Form.auth_group_name.value = auth_group_name;
		parent.document.softwareInfo_Form.manager_name.value = manager_name + " " + manager_position;
		parent.managerSearch_close();	
	}
		...
		<div class="pop_wrap pop_wrap_02">
			<div class="pop_inner">
				<div class="master_wrap master_layer">
					...
					<form id="searchPopForm" action="/software/popManagerList">
