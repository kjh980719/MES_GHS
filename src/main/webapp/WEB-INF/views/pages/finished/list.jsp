                    	...
                    	<%-- 		<col style="width: 100px;"/>
                    		...
                    		<tbody>
								...
								<c:if test="${empty list }">
									<tr><td colspan="11">출고검사 정보가 없습니다.</td></tr>
								</c:if>
			...
			<div class="pop_bg" onclick="workplanInfoLayer_Close();"></div>
				<div class="pop_wrap pop_wrap_01 pop_wrap_700" >
					...
					<form id="workplanInfo_Form" name="workplanInfo_Form">
						...
						<h3>최종검사 등록<a class="back_btn" href="#" onclick="workplanInfoLayer_Close();"><img src="/images/common/back_arrow.png" alt="뒤로가기"></a></h3>
