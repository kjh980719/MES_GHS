...
$(document).ready(function() {
    ...
    var searchmaterialList = function () {
        ...
        console.log(postData.CUST_CHECK_YN);
	...
	var registCust = function () {
	    ...
	    if($("#CustRegistForm input[name='rowIndex']").val() != "")
	        targetUrl = "/cust/updateCust.json";
    ...
    var colModel = [
        ...
        {label: "승인여부", name:"CUST_CHECK_YN", align: "center", width: "10%", sortable: false}
    ];
    ...
    creatJqGrid("jqGrid_1", "/partner/getPartnerList", colModel,  postData, "paginate_1", "dataCnt_1", "rowPerPage_1", "gridParent_1");
    ...
    $("#jqGrid_1").jqGrid('setGridParam', {
        onSelectRow: function(id) {
            ...
            $.ajax({
				type : "post",
				url : '/partner/selectPartner',
				contentType: "application/json",
				dataType : "json",
				async : false,
				data: JSON.stringify({"BUSINESS_NO": PCD}),
            ...
            $('#CustRegist').popup("show");
			setTableText(rowdata, "CustRegistForm");
        }
    });  
...
// 			console.log(r);
 	  ...
 	  function CheckFormat(cellValue, option, rowObject){
	    	return cellValue=='N'?'미승인': cellValue=='Y'?'승인':'미요청';
	   };
...
$(document).ready(function(){
	        if($("select[name=CUST_CHECK_YN]:checked").val() == "R"){
	        	$('input[name=RETURN_REASON]').show();
	            // radio 버튼의 value 값이 1이라면 활성화
	 
	        }else{
	        	$('input[name=RETURN_REASON]').hide();
	            // radio 버튼의 value 값이 0이라면 비활성화
	        }
    // 라디오버튼 클릭시 이벤트 발생
    $("input:radio[name=CUST_CHECK_YN]").click(function(){
 
        if($("input[name=CUST_CHECK_YN]:checked").val() == "R"){
        	$('input[name=RETURN_REASON]').show();
            // radio 버튼의 value 값이 1이라면 활성화
...
<%--                         <tr>
                        ...
                        <tr><th scope="row">승인여부</th>
                            <td colspan="4" class="left_pt10">
                                <select name="CUST_CHECK_YN" class="sel_box selectSearch">
							...
							<caption>
							 제품 등록 양식</caption>
								...
								<tr>
									...
									<input type="text" name="POST_NO" class="text_box01" placeholder="주소1" />
									</td>
								</tr>
								<tr>
									<td class="left_pt10" style="width:80%">
 ...
 <div class="top_mt10 bottom_mt20">
							<table cellpadding="0" cellspacing="0" class="mjlist_tbl01 mjlist_tbl011">
								...
								<tr>
									...
									<td class="left_pt10" style="width:80%"><button type="button" onclick="openZipSearch()" >우편번호검색</button>
									<input type="text" name="DM_POST" class="text_box01 " placeholder="주소2" />
									</td>
								</tr>
								<tr>
									<td class="left_pt10" style="width:80%">
	...
	<div class="top_mt10 bottom_mt20">
							<table cellpadding="0" cellspacing="0" class="mjlist_tbl01 mjlist_tbl011">
								...
								<tr>
									<th scope="row">아이디 </th>
									<td class="left_pt10" style="width:80%; text-align:right;">
									<input type="text" name="CUST_ID" class="text_box01 w_98 " placeholder="아이디" />
									</td>
								</tr>
								...
								<tr>
									...
									<td class="left_pt10" style="width:80%; text-align:right;">
									<input type="text" name="CUST_PW" class="text_box01 w_98 " placeholder="비밀번호" />
									</td>
								</tr>
								...
								<tr>
									...
									<td class="left_pt10" style="width:80%;">
									<input type="radio" name="CANCEL" value="N" checked="checked"/>사용
									<input type="radio" name="CANCEL" value="Y" />미사용
									</td>
								</tr>

								<tr>
									<th scope="row">계정승인 </th>
									<td class="left_pt10" style="width:40%;">
									<input type="radio" name="CUST_CHECK_YN" value="N" checked="checked"/>미승인
									<input type="radio" name="CUST_CHECK_YN" value="Y"/>승인
									<input type="radio" name="CUST_CHECK_YN" value="R"/>승인반려
									</td>
									</tr>
									<tr>
									<th scope="row">반려사유 </th>
									<td class="left_pt10" style="width:40%;">
									<input type="text" name="RETURN_REASON" class="text_box01" value="0" placeholder="반려사유"/>
									</td>
								</tr>
								</table>
												</div>
