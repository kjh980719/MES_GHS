...
$(document).ready(function() {
    ...
    var PalletColModel = [{label: "No", name:"rowIndex", align: "center", width: "10%", sortable: false},
        {label: "파레트번호", name:"pallet_num", align: "center", width: "10%", sortable: false},
        {label: "파레트바코드정보", name:"pallet_data", align: "center", width: "10%", sortable: false},
        {label: "사용유무", name:"pallet_using", align: "center", width: "10%", sortable: false, formatter : useYnFormat}
    ];
    ...
    creatJqGrid("jqGrid_1", "/pallet/getPalletList", PalletColModel,  postData, "paginate_1", "dataCnt_1", "rowPerPage_1", "gridParent_1");
