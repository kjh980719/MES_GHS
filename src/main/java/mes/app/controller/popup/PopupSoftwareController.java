...
public class PopupSoftwareController{
    ...
    public Map getManagerList(Model model,@RequestParam Map param) {
         ...
         resultMap.put("list", softwareservice.getMangerList(paramMap));
         resultMap.put("total", softwareservice.getMangerListTotal(paramMap));
