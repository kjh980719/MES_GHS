...
$(document).ready(function() {
    ...
    var colModel = [
        ...
        {label: "창고번호", name:"STORAGE_SEQ", align: "center", width: "10%", sortable: false},
        {label: "창고코드", name:"STORAGE_CODE", align: "center", width: "10%", sortable: false},
        {label: "창고명", name:"STORAGE_NAME1", align: "center", width: "10%", sortable: false}
    ];
    ...
    creatJqGrid("jqGrid_1", "/material/getMaterialStockStorageList", colModel,  postData, "paginate_1", "dataCnt_1", "rowPerPage_1", "gridParent_1");
				...
				<div class="layer_win01" style="width:800px;display: none;" id="MaterialStock">
					<div>
						<form id="MaterialStockStorageForm">
							...
							<h3 class="mjtit_top">
								<span id="actionText">창고별재고현황</span>
							...
							<div class="top_mt10 bottom_mt20">
							<table id="StockList" cellpadding="0" cellspacing="0" class="mjlist_tbl01 mjlist_tbl011">
