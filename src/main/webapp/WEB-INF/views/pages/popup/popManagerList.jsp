...
<script>
	...
	function choiceManager(manager_seq, auth_group_name, manager_name, manager_position){
		if ("${param.type}" == "cust"){
			parent.document.custInfo_Form.MANAGER_SEQ.value = manager_seq;
			parent.document.custInfo_Form.MANAGER_NAME.value = manager_name;
			parent.managerSearch_close();
		}else if ("${param.type}" == "in"){
			parent.document.inmaterialInfo_Form.manager_seq.value = manager_seq;
			parent.document.inmaterialInfo_Form.auth_group_name.value = auth_group_name;
			parent.document.inmaterialInfo_Form.manager_name.value = manager_name + " " + manager_position;
			parent.managerSearch_close();
		}else{
			parent.document.workplanInfo_Form.manager_seq.value = manager_seq;
			parent.document.workplanInfo_Form.auth_group_name.value = auth_group_name;
			parent.document.workplanInfo_Form.manager_name.value = manager_name + " " + manager_position;
			parent.managerSearch_close();
		}
