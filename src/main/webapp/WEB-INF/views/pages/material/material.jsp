...
<div class="master_cont">
    <!--  관리자  검색시작-->
    <form id="searchForm" action="/material/material">
            ...
            <div class="sel_wrap sel_wrap1">
                <select name="PROD_TYPE" class="sel_02">
                    ...
                    <c:forEach items="${productGubun}" var="result">
                        <c:if test="${result.code eq 'PG001' or result.code eq 'PG002' or result.code eq 'PG004'}">
                                ...
                                <table class="master_02 ">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3" style="width:80%">
                                            <input type="text" id="PDT_CODE" name="PDT_CODE" class="all"
                                                   placeholder="제품코드 입력" alt="제품코드" maxlength="100"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td colspan="3">
                                            <div class="sel_wrap">
                                                <select id="cate1" name="CATE1" class="sel_02"
                                                        onchange="choiceCategory(this.value, 1)">
                                                    <c:forEach var="list" items="${category}">
                                            ...
                                            <div id="category2" class="sel_wrap" style="display: none">
                                                <select id="cate2" name="CATE2" class="sel_02"
                                                        onchange="choiceCategory(this.value, 2)">
                                            ...
                                            <div class="radiobox">
                                                <c:forEach items="${productGubun}" var="result" varStatus="i">
                                                    <label for="PROD_TYPE${i.count}">
                                                        <input type="radio" id="PROD_TYPE${i.count}" name="PROD_TYPE" value="${result.code}"<c:if test="${i.count eq 1}">checked</c:if> ><span>${result.code_nm}</span>
                                                    </label>
                                                </c:forEach>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3">
                                            ...
                                            <input type="text" id="CUST_NAME" name="CUST_NAME" class="all"
                                                   placeholder="구매처" alt="구매처" onclick="openLayer();" readonly/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row">바코드</th>
                            ...
                            <div id="tab-2" class="tab_box tab_box2">
                                <table class="master_02 ">
                                    ...
                                    <tr>
										...
										<input type="text" id="TAX" name="TAX" class="small tc"
                                               onkeyup="this.value=this.value.replace(/[^0-9]/g,'');" value="0"/>%
									</span>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3">
                                            ...
                                            <div class="radiobox">
                                                ...
                                                <label for="VAT_RATE_BY_BASE_Y">
                                                    <input type="radio" id="VAT_RATE_BY_BASE_Y"
                                                           name="VAT_RATE_BY_BASE_YN" value="Y"
                                                           class="sel_view sel_view3"><span>직접입력</span>
                                                </label>
											...
											<input type="text" id="VAT_RATE_BY" name="VAT_RATE_BY" class="small tc"
                                    ...
                                    <tr>
                                        <th scope="row">적요</th>
                                        <td colspan="3">
                                            <input type="text" id="PDT_BIGO" name="PDT_BIGO" class="all"
                                                   placeholder="적요"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td colspan="3">
                                            <div class="radiobox">
                                                <label for="INSPECT_STATUS_L">
                                                    <input type="radio" id="INSPECT_STATUS_L" name="INSPECT_STATUS"
                                                           value="L"><span>전수</span>
                                                </label>
                                                <label for="INSPECT_STATUS_S">
                                                    <input type="radio" id="INSPECT_STATUS_S" name="INSPECT_STATUS"
                                                           value="S" class="sel_view sel_view4"><span>샘플링</span>
                                                </label>

                                            </div>
                                            <span class="g_business_view g_business_view4 g_business_none">
                                                <input type="text" id="SAMPLE_PERCENT" name="SAMPLE_PERCENT"
                                                       onkeyup="this.value=this.value.replace(/[^0-9]/g,'');"
                                                       class="small tc" value="0"/>%
                                            </span>
                                        </td>
                                    </tr>
                                ...
                                <table class="master_02 ">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3">
                                            ...
                                            <input type="text" id="DENO_RATE" name="DENO_RATE"
                                                   onkeyup="this.value=this.value.replace(/[^0-9]/g,'');"
                                                   class="text_box01 w_98" placeholder="BOX"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="3">
                                            <span class="tit">수량</span>
                                            <input type="text" id="EXCH_RATE" name="EXCH_RATE"
                                                   onkeyup="this.value=this.value.replace(/[^0-9]/g,'');"
                                                   class="text_box01 w_98" placeholder="수량"/>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3"><input type="text" id="SAFE_STOCK" name="SAFE_STOCK" value="0"
                                                               placeholder="안전재고수량"
                                                               onkeyup="this.value=this.value.replace(/[^0-9]/g,'');"/>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3">
                                            <div class="sel_wrap">
                                                <select id="CSORD_C0001" name="CSORD_C0001" class="sel_02"
                                                        onchange="ChangeCSORD(this);">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3">
                                            <input type="text" name="PDT_STOCK" id="PDT_STOCK" value="0" placeholder="재고수량" onkeyup="this.value=this.value.replace(/[^0-9]/g,'');"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row">조달기간</th>
                                        <td colspan="3">
                                            <input type="text" id="IN_TERM" name="IN_TERM"
                                                   class="text_box01  firstFocus" placeholder="조달기간"/>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3"><input type="text" id="MIN_QTY" name="MIN_QTY"
                                                               class="text_box01 w_98" placeholder="최소구매단위"/></td>
                                    </tr>
                                    </tbody>
                                </table>
                            </div>
                            ...
                            <div id="tab-4" class="tab_box tab_box4">
                                <table class="master_02 ">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3">
                                            <input type="text" id="IN_PRICE" name="IN_PRICE" class="text_box01 w_80 "
                                                   value="0" onkeyup="this.value=this.value.replace(/[^0-9]/g,'');"
                                                   placeholder="입고단가" alt="입고단가"/>
                                            <div class="chkbox chkbox1">
                                                <input type="hidden" id="IN_PRICE_VAT_YN" name="IN_PRICE_VAT_YN">
                                                <label for="IN_PRICE_VAT_YN_CHK">
                                                    <input type="checkbox" id="IN_PRICE_VAT_YN_CHK"
                                                           name="IN_PRICE_VAT_YN_CHK">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3">
                                            <input type="text" id="OUT_PRICE" name="OUT_PRICE" class="text_box01 w_80 "
                                                   value="0" onkeyup="this.value=this.value.replace(/[^0-9]/g,'');"
                                                   placeholder="출고단가" alt="출고단가"/>
                                            <div class="chkbox chkbox1">
                                                <input type="hidden" id="OUT_PRICE_VAT_YN" name="OUT_PRICE_VAT_YN"/>
                                                <label for="OUT_PRICE_VAT_YN_CHK">
                                                    <input type="checkbox" id="OUT_PRICE_VAT_YN_CHK"
                                                           name="OUT_PRICE_VAT_YN_CHK">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3">
                                            <input type="text" id="OUT_PRICE1" name="OUT_PRICE1"
                                                   class="text_box01 w_80 " value="0"
                                                   onkeyup="this.value=this.value.replace(/[^0-9]/g,'');"
                                                   placeholder="원가" alt="원가"/>
                                            <div class="chkbox chkbox1">
                                                <input type="hidden" id="OUT_PRICE1_VAT_YN" name="OUT_PRICE1_VAT_YN"/>
                                                <label for="OUT_PRICE1_VAT_YN_CHK">
                                                    <input type="checkbox" id="OUT_PRICE1_VAT_YN_CHK"
                                                           name="OUT_PRICE1_VAT_YN_CHK">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3">
                                            <input type="text" id="OUT_PRICE2" name="OUT_PRICE2"
                                                   class="text_box01 w_80 " value="0"
                                                   onkeyup="this.value=this.value.replace(/[^0-9]/g,'');"
                                                   placeholder="대리점가" alt="대리점가"/>
                                            <div class="chkbox chkbox1">
                                                <input type="hidden" id="OUT_PRICE2_VAT_YN" name="OUT_PRICE2_VAT_YN"/>
                                                <label for="OUT_PRICE2_VAT_YN_CHK">
                                                    <input type="checkbox" id="OUT_PRICE2_VAT_YN_CHK"
                                                           name="OUT_PRICE2_VAT_YN_CHK">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3">
                                            <input type="text" id="OUT_PRICE3" name="OUT_PRICE3"
                                                   class="text_box01 w_80 " value="0"
                                                   onkeyup="this.value=this.value.replace(/[^0-9]/g,'');"
                                                   placeholder="소비자가" alt="소비자가"/>
                                            <div class="chkbox chkbox1">
                                                <input type="hidden" id="OUT_PRICE3_VAT_YN" name="OUT_PRICE3_VAT_YN"/>
                                                <label for="OUT_PRICE3_VAT_YN_CHK">
                                                    <input type="checkbox" id="OUT_PRICE3_VAT_YN_CHK"
                                                           name="OUT_PRICE3_VAT_YN_CHK">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3">
                                            <input type="text" id="LABOR_WEIGHT" name="LABOR_WEIGHT"
                                                   onkeyup="this.value=this.value.replace(/[^0-9]/g,'');"
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3">
                                            <input type="text" id="EXPENSES_WEIGHT" name="EXPENSES_WEIGHT"
                                                   onkeyup="this.value=this.value.replace(/[^0-9]/g,'');"
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3">
                                            <input type="text" id="MATERIAL_COST" name="MATERIAL_COST"
                                                   onkeyup="this.value=this.value.replace(/[^0-9]/g,'');"
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3">
                                            <input type="text" id="EXPENSE_COST" name="EXPENSE_COST"
                                                   onkeyup="this.value=this.value.replace(/[^0-9]/g,'');"
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3">
                                            <input type="text" id="OUT_COST" name="OUT_COST" class="text_box01 w_98 "
                                                   onkeyup="this.value=this.value.replace(/[^0-9]/g,'');"
                                                   value="0"/>
                                        ...
                                        <td colspan="3">
                                            <div class="radiobox">
                                                <label for="SERIAL_TYPE1">
                                                    <input type="radio" id="SERIAL_TYPE1" name="SERIAL_TYPE" value="B"
                                                           checked="checked"><span>기본설정</span>
                                                </label>
                                                ...
                                                <label for="SERIAL_TYPE3">
                                                    <input type="radio" id="SERIAL_TYPE3" name="SERIAL_TYPE"
                                                           value="M"><span>선택입력</span>
                                                </label>
                                                <label for="SERIAL_TYPE4">
                                                    <input type="radio" id="SERIAL_TYPE4" name="SERIAL_TYPE"
                                                           value="N"><span>사용안함</span>
                                                </label>
                                            </div>
