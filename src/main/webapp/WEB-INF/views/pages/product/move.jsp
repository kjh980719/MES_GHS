        ...
        <!--  관리자  검색시작-->
                    ...
                    <form id="searchForm" action="/product/in">
                  	...
                  	<div class="srch_day">
                    	<div class="day_area">
                    		<div class="day_label">
                    		<label for="startDate">재고이동일자</label>
                    		</div>
                    		<div class="day_input">
						...
						<div class="sel_wrap sel_wrap1">
                  		...
                  		<div class="sel_wrap sel_wrap1">
                    		<select name="search_type" class="sel_02"> 
								...
								<option value="IO_CODE" <c:if test="${search.search_type == 'IO_CODE'}">selected</c:if>>재고이동코드</option>
                            </select>
                    	</div>
	                  		...
	                  		<table class="master_01">
	                    		...
	                    		<tbody>
									...
									<c:if test="${empty list }">
										<tr><td colspan="6">재고이동 정보가 없습니다.</td></tr>
									</c:if>
			...
			<div class="pop_bg" onclick="inmaterialInfoLayer_Close();"></div>
				<div class="pop_wrap pop_wrap_01" >
					...
					<form id="inmaterialInfo_Form" name="inmaterialInfo_Form">
						...
						<h3>재고이동관리<a class="back_btn" href="#" onclick="inmaterialInfoLayer_Close();"><img src="/images/common/back_arrow.png" alt="뒤로가기"></a></h3>
						...
						<div class="master_list master_listB">
							<table  class="master_02 master_04">	
								...
								<tbody>
                                    ...
                                    <tr>
                                        <th scope="row">재고이동일자 <span class="keyf01">*</span></th>
                                        <td>
...
<script type="text/javascript">
	...
	function InmaterialInfoLayer_Open(io_seq, type){
				...
				$.ajax({
		            ...
		            success : function(data) {
		            	...
		            	if (array.length > 0) {
		            		...
		            		text += "<tr class='all'><td colspan='11'>재고이동정보가 없습니다.</td></tr>";
		            	}
		...
		function GoActionButton(){
			...
			var mode = $('#mode').val();
			if (mode == 'register') {
				targetUrl = "/product/registerMove";
			} else {
				targetUrl = "/product/updateMove";
			}
	...
	function PopWorkPlanAdd(data){
		...
		for (var i in array){
			...
			text += "<td class='qty'><input type='text' id='qty_" + num + "' name='qty' value='"+comma(array[i].planqty)+"' onkeyup='this.value=this.value.replace(/[^0-9]/g,\"\"); this.value=comma(this.value); priceChange(" + num + ");' maxlength='12' placeholder='재고이동수량'></td>";
